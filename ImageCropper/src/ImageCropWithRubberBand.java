...
//      Image image = new Image( getClass().getResource( "cat.jpg").toExternalForm());
        ...
        primaryStage.setTitle("SoukLemdina - Image Crop");
...
//        File file = new File("/opt/lampp/htdocs/SoukLemdina/web/uploads/images/" + System.getProperty("user.name") + ".jpg");
        File file = new File(System.getProperty("user.home") + "/Desktop/" + System.getProperty("user.name") + ".jpg");
    ...
    public static class RubberBandSelection {
        ...
        EventHandler<MouseEvent> onMouseDraggedEventHandler = new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                double offsetY = event.getX() - dragContext.mouseAnchorX;
