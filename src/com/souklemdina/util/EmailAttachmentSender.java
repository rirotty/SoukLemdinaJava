...
public class EmailAttachmentSender {
  ...
  String port="587" ;
  final String userName="rahmabenromdhane15@gmail.com" ;
  final String password="witchmag";
    ...
    public static void main(String[] args) {
        ...
        // message info
        String mailTo = "rirotty15@yahoo.fr";
        String subject = "This is a message from Souk Lemdina team";
